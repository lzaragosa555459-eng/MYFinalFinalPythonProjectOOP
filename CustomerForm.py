...
labelName = tk.Label(CustomerFrame,bg="#2D2B55", text="Name",fg="#A599E9") 
...
labelEmail = tk.Label(CustomerFrame,bg="#2D2B55", text="Email",fg="#A599E9")
...
labelPhone = tk.Label(CustomerFrame,bg="#2D2B55", text="Phone",fg="#A599E9")
...
Label = tk.Label(CustomerFrame, text="",bg="#2D2B55",fg="#A599E9").grid(row=3, column=3, padx=15, pady=10)
Label = tk.Label(CustomerFrame, text="Customer Information",bg="#2D2B55",fg="#A599E9").grid(row=4, column=1, padx=0, pady=10)
...
LayoutPaymentMethod = tk.Label(TransactionFrame,bg="#2D2B55", text="Pay Method",fg="#A599E9")
...
labelAmount = tk.Label(TransactionFrame,bg="#2D2B55", text="Amount",fg="#A599E9")
...
LayoutRentalDate = tk.Label(TransactionFrame,bg="#2D2B55", text="Rental Date",fg="#A599E9")
...
ReturnDate = tk.Label(TransactionFrame,bg="#2D2B55", text="Return Date",fg="#A599E9") 
...
Label = tk.Label(TransactionFrame, text="",bg="#2D2B55",fg="#A599E9").grid(row=3, column=3, padx=13, pady=0)
Label = tk.Label(TransactionFrame, text="Transaction Information",bg="#2D2B55",fg="#A599E9").grid(row=5, column=1, padx=0, pady=10)
...
VehName = tk.Label(VehicleFrame,bg="#2D2B55", text="Vehicle",fg="#A599E9")
...
labelPrice = tk.Label(VehicleFrame,bg="#2D2B55", text="Cost",fg="#A599E9") 
...
Label = tk.Label(VehicleFrame, text="",bg="#2D2B55",fg="#A599E9").grid(row=2, column=3, padx=12, pady=30)
Label = tk.Label(VehicleFrame, text="Vehicle Information",bg="#2D2B55",fg="#A599E9").grid(row=3, column=1, padx=0, pady=10)
...
Submit = tk.Button(root, text="Submit",borderwidth = 2, highlightthickness=0,bg="#1E1E3F",fg="#A599E9",highlightcolor="goldenrod",highlightbackground="black",command=add).place(relx=0.87, rely = 0.92, anchor ="center")
Clear = tk.Button(root, text="Clear",command=clear,borderwidth = 2, highlightthickness=0,bg="#1E1E3F",fg="#A599E9",highlightcolor="goldenrod",highlightbackground="black").place(relx=0.94, rely = 0.92, anchor ="center")

style = ttk.Style()
style.theme_use("default")
labelTable = tk.Label(root,text="Select a Vehicle",bg="#2D2B55",fg="#A599E9").place(relx =0.26,rely =0.59, anchor="center")
...
labelAT = tk.Label(root,text="@LizZaragosa",bg="#2D2B55",fg="#A599E9").place(relx =0.10,rely =0.97, anchor="center")
