...
titlelabel = tk.Label(root, text="CAR RENTALS AND SERVICES", fg="#FAD000",bg="#2D2B55").place(relx=0.19, rely = 0.05, anchor = tk.CENTER)
...
labelName.grid(row=0, column=0, padx=0, pady=10, sticky="w")
...
labelEmail.grid(row=1, column=0, padx=0, pady=10, sticky="w")
...
labelPhone.grid(row=2, column=0, padx=0, pady=10, sticky="w")
...
LayoutPaymentMethod.grid(row=0, column=0, padx=0, pady=10, sticky="w")
...
labelAmount.grid(row=1, column=0, padx=0, pady=10, sticky="w")
...
LayoutRentalDate.grid(row=2, column=0, padx=0, pady=10, sticky="w")
...
ReturnDate.grid(row=3, column=0, padx=0, pady=10, sticky="w")
...
VehName.grid(row=0, column=0, padx=0, pady=10, sticky="w")
...
labelPrice.grid(row=1, column=0, padx=0, pady=10, sticky="w")
...
labelTable = tk.Label(root,text="Select a Vehicle",bg="#2D2B55",fg="white").place(relx =0.33,rely =0.64, anchor="center")
...
def calendar():
    ...
    setCalendar(Enter_RentalDate,root)

def calendarReturn():
    subprocess.Popen(["python","Calendar.py"])
    setCalendar(Enter_ReturnDate,root)

CalendarPicker = tk.Button(root,text="Pick", command=calendar)
CalendarPicker.place(relx =0.574,rely =0.322, anchor="center")
CalendarPicker = tk.Button(root,text="Pick", command=calendarReturn)
CalendarPicker.place(relx =0.574,rely =0.385, anchor="center")
