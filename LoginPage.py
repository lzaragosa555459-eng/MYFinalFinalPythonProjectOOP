...
labelName = tk.Label(panel2InnerFrame, fg="white", bg = "#2D2B55", text="Name")
...
labelPassword = tk.Label(panel2InnerFrame,fg="white" ,bg = "#2D2B55", text="Password") 
...
def login():
    ...
    if username == "Admin" and password == "1234":
        ...
        label = tk.Label(panel2InnerFrame, text="Invalid Credentials. try again!", bg = "#2D2B55",fg="white")
        label.grid(row=3, column=1, padx=10, pady=10)


LoginButton = tk.Button(panel2InnerFrame, text="Login", command=login, borderwidth = 2, highlightthickness=0,bg="#1E1E3F",fg="white",highlightcolor="goldenrod",highlightbackground="black")
