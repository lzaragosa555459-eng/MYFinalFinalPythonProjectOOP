...
class RentalFrame(tk.Frame):
    def __init__(self, parent,controller):
        ...
        labelCustomerID = tk.Label(InnerFrameRental1Ver2,bg="#2D2B55", text="PaymentID",fg="white")
        labelCustomerID.grid(row=0, column=0, padx=0, pady=10, sticky="e")

        Enter_RentalID = tk.Entry(InnerFrameRental1Ver2, width=15, textvariable=rentalid_var,relief="flat",bg="white")
        ...
        Enter_RentalDate = tk.Entry(InnerFrameRental1Ver2, width=15, textvariable=rentaldate_var,relief="flat",bg="white")
        ...
        Enter_ReturnDate = tk.Entry(InnerFrameRental1Ver2, width=15, textvariable=returndate_var,relief="flat",bg="white")
        ...
        Enter_CustomerID = tk.Entry(InnerFrameRental1Ver2, width=13, textvariable=customerid_var,relief="flat",bg="white")
        ...
        Enter_VehicleID = tk.Entry(InnerFrameRental1Ver2, width=13, textvariable=vehicleid_var,relief="flat",bg="white")
