...
from sql import loadRentals ,Update2,Delete2
...
class RentalFrame(tk.Frame):
    def __init__(self, parent,controller):
        ...
        labelCustomerID = tk.Label(InnerFrameRental1Ver2,bg="#2D2B55", text="RentalID",fg="white")
        labelCustomerID.grid(row=0, column=0, padx=0, pady=10, sticky="w")

        Enter_RentalID = tk.Entry(InnerFrameRental1Ver2, width=20, textvariable=rentalid_var,relief="flat",bg="white")
        Enter_RentalID.grid(row=0, column=1, padx=0, pady=10) 

        LayoutRentalDate = tk.Label(InnerFrameRental1Ver2,bg="#2D2B55", text="Payment Method",fg="white")
        LayoutRentalDate.grid(row=1, column=0, padx=0, pady=10, sticky="w")
        
        Enter_RentalDate = tk.Entry(InnerFrameRental1Ver2, width=20, textvariable=rentaldate_var,relief="flat",bg="white")
        Enter_RentalDate.grid(row=1, column=1, padx=0, pady=10)

        ReturnDate = tk.Label(InnerFrameRental1Ver2,bg="#2D2B55", text="Date",fg="white") 
        ReturnDate.grid(row=2, column=0, padx=0, pady=10, sticky="w")
        
        Enter_ReturnDate = tk.Entry(InnerFrameRental1Ver2, width=20, textvariable=returndate_var,relief="flat",bg="white")
        Enter_ReturnDate.grid(row=2, column=1, padx=0, pady=10)

        labelCustomerID = tk.Label(InnerFrameRental1Ver2,bg="#2D2B55", text="CustomerID",fg="white") 
        labelCustomerID.grid(row=3, column=0, padx=0, pady=10, sticky="w")
        
        Enter_CustomerID = tk.Entry(InnerFrameRental1Ver2, width=20, textvariable=customerid_var,relief="flat",bg="white")
        Enter_CustomerID.grid(row=3, column=1, padx=0, pady=10)

        labelVehicleID = tk.Label(InnerFrameRental1Ver2,bg="#2D2B55", text="VehicleID",fg="white") 
        labelVehicleID.grid(row=4, column=0, padx=0, pady=10, sticky="w")
        
        Enter_VehicleID = tk.Entry(InnerFrameRental1Ver2, width=20, textvariable=vehicleid_var,relief="flat",bg="white")
        Enter_VehicleID.grid(row=4, column=1, padx=0, pady=10)
        ...
        tableRentals.place(relx =0.45,rely =0.7, anchor="center")
