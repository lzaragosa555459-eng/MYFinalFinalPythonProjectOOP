...
from sql import loadPayment,Update1,Delete1
class PaymentFrame(tk.Frame):
    def __init__(self, parent,controller):
        ...
        labelPaymentID.grid(row=0, column=0, padx=0, pady=10, sticky="w")
        ...
        LayoutPaymentMethod.grid(row=1, column=0, padx=0, pady=10, sticky="w")
        ...
        PaymentDate.grid(row=2, column=0, padx=0, pady=10, sticky="w")
        ...
        labelAmount.grid(row=3, column=0, padx=0, pady=10, sticky="w")
        ...
        labelRentalID.grid(row=4, column=0, padx=0, pady=10, sticky="w")
