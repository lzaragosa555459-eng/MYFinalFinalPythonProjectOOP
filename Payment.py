...
class PaymentFrame(tk.Frame):
    def __init__(self, parent,controller):
        ...
        labelPaymentID = tk.Label(InnerFramePayment1Ver2,bg="#2D2B55", text="PaymentID",fg="#A599E9")
        labelPaymentID.grid(row=0, column=0, padx=0, pady=10, sticky="e")

        Enter_PaymentID = tk.Entry(InnerFramePayment1Ver2, width=20, textvariable=paymentid_var,relief="flat",bg="#A599E9")
        Enter_PaymentID.grid(row=0, column=1, padx=0, pady=10) 

        LayoutPaymentMethod = tk.Label(InnerFramePayment1Ver2,bg="#2D2B55", text="Payment Method",fg="#A599E9") 
        LayoutPaymentMethod.grid(row=1, column=0, padx=0, pady=10, sticky="e")
        
        Enter_PaymentMethod = tk.Entry(InnerFramePayment1Ver2, width=20, textvariable=paymentMethod_var,relief="flat",bg="#A599E9")
        Enter_PaymentMethod.grid(row=1, column=1, padx=0, pady=10)

        PaymentDate = tk.Label(InnerFramePayment1Ver2,bg="#2D2B55", text="Date",fg="#A599E9") 
        PaymentDate.grid(row=2, column=0, padx=0, pady=10, sticky="e")
        
        Enter_PaymentDate = tk.Entry(InnerFramePayment1Ver2, width=20, textvariable=Date_var,relief="flat",bg="#A599E9")
        Enter_PaymentDate.grid(row=2, column=1, padx=0, pady=10)

        labelAmount = tk.Label(InnerFramePayment1Ver2,bg="#2D2B55", text="Amount",fg="#A599E9") 
        labelAmount.grid(row=3, column=0, padx=0, pady=10, sticky="e")
        
        Enter_Amount = tk.Entry(InnerFramePayment1Ver2, width=20, textvariable=amount_var,relief="flat",bg="#A599E9")
        Enter_Amount.grid(row=3, column=1, padx=0, pady=10)

        labelRentalID = tk.Label(InnerFramePayment1Ver2,bg="#2D2B55", text="RentalID",fg="#A599E9") 
        labelRentalID.grid(row=4, column=0, padx=0, pady=10, sticky="e")
        
        Enter_Rental = tk.Entry(InnerFramePayment1Ver2, width=20, textvariable=rental_var,relief="flat",bg="#A599E9")
