...
from sql import Update, load, Delete
...
class CustomerFrame(tk.Frame):
    def __init__(self,parent,controller):
        ...
        labelID = tk.Label(InnerFrameCustomer1Ver2,bg="#2D2B55", text="Customer ID",fg="white")
        labelID.grid(row=0, column=0, padx=0, pady=10, sticky="w")

        Enter_ID = tk.Entry(InnerFrameCustomer1Ver2, width=20, textvariable=id_var,relief="flat",bg="white")
        Enter_ID.grid(row=0, column=1, padx=0, pady=10) 

        labelName = tk.Label(InnerFrameCustomer1Ver2,bg="#2D2B55", text="Name",fg="white") 
        labelName.grid(row=1, column=0, padx=0, pady=10, sticky="w")

        Enter_Name = tk.Entry(InnerFrameCustomer1Ver2, width=20, textvariable=name_var,relief="flat",bg="white")
        Enter_Name.grid(row=1, column=1, padx=0, pady=10)

        labelEmail = tk.Label(InnerFrameCustomer1Ver2,bg="#2D2B55", text="Email",fg="white") 
        labelEmail.grid(row=2, column=0, padx=0, pady=10, sticky="w")

        Enter_Email = tk.Entry(InnerFrameCustomer1Ver2, width=20, textvariable=email_var,relief="flat",bg="white")
        Enter_Email.grid(row=2, column=1, padx=0, pady=10)

        labelPhone = tk.Label(InnerFrameCustomer1Ver2,bg="#2D2B55", text="Phone",fg="white") 
        labelPhone.grid(row=3, column=0, padx=0, pady=10, sticky="w")

        Enter_Phone = tk.Entry(InnerFrameCustomer1Ver2, width=20, textvariable=phone_var,relief="flat",bg="white")
